...
def cross_validation_deep_forest(x, y, n_splits=5):
    ...
    for train_idx, val_idx in kf.split(x):
        ...
        model = CascadeForestRegressor(random_state=1, n_estimators=2)  # adjust as needed
...
for i in tqdm(list(gene_list["x"])):
    ...
    if len(a.columns) == 1:
        ...
        mean_r2 = cross_validation_deep_forest(train_x, train_y)
        File = open("../result_r2/DeepForest.txt", 'a')   
